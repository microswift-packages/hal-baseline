...
public protocol TimerFastPWM8BitConfigurable: TimerPeripheral {
  ...
  static func configureModeFastPWM8Bit(clock: ClockSelect)

  /// Checks if the timer is currently in 8-bit Fast PWM mode.
  @inlinable @inline(__always)
  static var isModeFastPWM8Bit: Bool { get }
}
